          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-4 text-center">
                ...
                <div className="text-gray-500 text-sm">Total Barang</div>
              </div>
            ...
            {/* Search Bar */}
            <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-3 sm:p-4">
                          ...
                          >
                            ...
                            <td className="px-3 sm:px-4 py-2 sm:py-3 whitespace-nowrap text-center">
                              <input
                                ...
                                className="bg-slate-900/60 border border-gray-200 rounded-lg px-3 py-2 text-white text-sm w-24 text-center focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                placeholder="0"
                                min="0"
                              />
                            </td>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <input
                              ...
                              className="bg-slate-900/60 border border-gray-200 rounded-lg px-3 py-2 text-white text-sm w-20 text-center focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                              placeholder="0"
                              min="0"
                            />
                          </div>
              ...
              <div className="p-3 sm:p-4 space-y-4">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    ...
                    <span className="text-gray-500 transform transition-transform text-xs flex-shrink-0">
                      {showKasirDropdown ? "▲" : "▼"}
                    </span>
                  </button>

                  {showKasirDropdown && (
                    <div className="absolute z-10 w-full mt-1 bg-slate-800 border border-gray-200 rounded-xl shadow-lg backdrop-blur-lg max-h-60 overflow-y-auto">
                      {kasirToList.map((kasir) => (
                        <button
                          ...
                          className="w-full px-3 py-2 text-sm text-white text-left hover:bg-slate-700/60 transition-colors first:rounded-t-xl last:rounded-b-xl border-b border-gray-200 last:border-b-0"
                        >
