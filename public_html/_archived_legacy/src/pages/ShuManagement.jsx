    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600">Memuat data SHU...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-4 px-3 sm:px-4">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl space-y-4 sm:space-y-6">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            onClick={() => navigate("/dashboard")}
            className="px-6 py-3 bg-slate-600 text-gray-600 rounded-xl hover:bg-slate-500 transition-colors border border-slate-500 font-medium"
          >
            Kembali ke Dashboard
          </button>
        </div>
