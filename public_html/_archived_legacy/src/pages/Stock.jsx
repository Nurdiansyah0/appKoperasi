    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600">Memuat data stok...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 px-3 sm:px-4">
              ...
              <div className="max-h-[500px] overflow-y-auto">
                <table className="w-full min-w-0">
                  <thead className="bg-white sticky top-0 border-b border-gray-200">
                    <tr>
                      <th
                        className="px-2 sm:px-3 py-2 text-left text-xs font-medium text-gray-600 uppercase tracking-wider cursor-pointer"
                      ...
                      <th
                        className="px-2 py-2 text-right text-xs font-medium text-gray-600 uppercase tracking-wider cursor-pointer"
                    ...
                    {sortedData.map((item) => (
                      ...
                      >
                        ...
                        <td className="px-2 py-3 text-right">
                          <span
                            className={`inline-flex px-2 py-1 text-xs font-medium rounded-full border ${item.stok_item > 20
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-3">
          <div className="bg-white rounded-2xl w-full max-w-sm p-4 space-y-4 shadow-xl text-gray-900">
            <h2 className="text-lg font-bold text-gray-800">Tambah Barang Baru</h2>
      ...
      {editingItem && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-3">
          <div className="bg-white rounded-2xl w-full max-w-sm p-4 space-y-4 shadow-xl text-gray-900">
            <h2 className="text-lg font-bold text-gray-800">Edit Barang</h2>
