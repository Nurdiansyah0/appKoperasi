...
const UserDashboard = () => {
  ...
  if (error && !memberData) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="relative z-10 text-center max-w-md p-6 bg-white border border-gray-100 shadow-sm rounded-2xl shadow-xl">
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      ...
      <div className="relative z-10 container mx-auto max-w-6xl space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-100 shadow-sm rounded-2xl shadow-xl p-6">
          ...
          <div className="bg-white border border-gray-100 shadow-sm rounded-2xl shadow-xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-gray-500 text-sm">Hutang</p>
            </div>
          ...
          <div className="bg-white border border-gray-100 shadow-sm rounded-2xl shadow-xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-gray-500 text-sm">SHU</p>
            </div>
              ...
              <div className="space-y-3 max-h-96 overflow-y-auto">
                {historiHutang.map((item) => (
                  <div
                    ...
                    className="p-4 border border-gray-200 rounded-xl bg-slate-900/40 backdrop-blur-sm hover:bg-slate-800/40 transition-colors"
                  >
