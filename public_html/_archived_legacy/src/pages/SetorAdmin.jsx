      ...
      <div className="relative z-10 container mx-auto max-w-2xl space-y-4 sm:space-y-6">
        ...
        <div className="bg-white border border-gray-100 shadow-sm rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-900/60 border border-gray-200 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent text-lg font-medium pr-20"
                    min="1"
                    required
                  />
            ...
            {/* Information Panel */}
            <div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[50000, 100000, 250000, 500000].map((amount) => (
                  <button
                    ...
                    className="px-3 py-2 bg-slate-700/60 hover:bg-slate-600/60 border border-gray-200 rounded-xl text-gray-600 hover:text-white transition-colors text-sm font-medium"
                  >
