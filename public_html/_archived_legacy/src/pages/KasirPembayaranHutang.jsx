    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600">Memuat data pembayaran...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 px-3 sm:px-4">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl space-y-4 sm:space-y-6">
        ...
        {/* Tab Navigation */}
        <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-1">
            ...
            <button
              ...
              className={`flex-1 py-2 px-3 text-sm font-medium rounded-xl transition-all ${
                activeTab === "pending"
                  ...
                  : "text-gray-500 hover:text-white hover:bg-slate-700/60"
              }`}
            >
              Pending
