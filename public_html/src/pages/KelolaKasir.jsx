    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#061226] via-[#0b1220] to-[#07102a]">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-300">Memuat data kasir...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative z-10 container mx-auto max-w-7xl space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/dashboard"
              className="bg-slate-700/60 hover:bg-slate-600/60 text-white px-3 py-2 rounded-xl transition-colors border border-slate-600/40 text-sm"
            >
              ← Dashboard
            </Link>
              ...
              <div className="max-h-[500px] overflow-y-auto">
                <table className="w-full min-w-0">
                  <thead className="bg-slate-700/40 sticky top-0">
                    <tr>
                      <th className="px-2 sm:px-3 py-2 text-left text-xs font-medium text-slate-300 uppercase tracking-wider">
                        Kasir
                      </th>
      ...
      {showTambahForm && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-3">
          <div className="bg-gradient-to-tr from-slate-800/90 to-slate-900/90 backdrop-blur-lg border border-slate-700/40 rounded-2xl w-full max-w-sm p-4 space-y-4">
            <h2 className="text-lg font-bold text-white">Tambah Kasir Baru</h2>
