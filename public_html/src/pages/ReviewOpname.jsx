    ...
    <div className="min-h-screen bg-gradient-to-br from-[#061226] via-[#0b1220] to-[#07102a] py-4 px-3 sm:px-4">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-tr from-slate-800/60 to-slate-900/70 backdrop-blur-lg border border-slate-700/40 rounded-2xl shadow-xl">
              {/* Header */}
              ...
              <div className="max-h-96 overflow-y-auto">
                {serahTerimaList.length === 0 ? (
                  ...
                  serahTerimaList.map((item) => (
                    <div
                      key={item.serah_id}
                      className={`p-3 sm:p-4 border-b border-slate-600/40 cursor-pointer transition-all ${
              ...
              <div className="p-3 sm:p-4 max-h-96 overflow-y-auto">
                {!selectedOpname ? (
                  ...
                  <>
                    ...
                    {/* Tabel Detail */}
                    <div className="mb-4">
                      <h3 className="font-semibold text-slate-300 mb-3 text-sm sm:text-base">
                        Detail Barang:
                      </h3>
                        ...
                        <table className="w-full text-sm">
                          <thead className="bg-slate-700/40">
                            <tr>
                              ...
                              <th className="p-3 text-right text-xs font-medium text-slate-300 uppercase tracking-wider">
                                Stok Sistem
                              </th>
                              <th className="p-3 text-right text-xs font-medium text-slate-300 uppercase tracking-wider">
                                Stok Input
                              ...
                              <th className="p-3 text-center text-xs font-medium text-slate-300 uppercase tracking-wider">
                                Status
                              </th>
                            </tr>
                          </thead>
                    ...
                    {selectedOpname.status === "pending" && (
                      <div className="mt-6 p-4 bg-slate-700/40 rounded-xl border border-slate-600/40">
      ...
      {showRejectModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-600/40 rounded-2xl shadow-xl max-w-md w-full backdrop-blur-lg">
            <div className="p-6">
              ...
              <textarea
                ...
                className="w-full h-32 p-3 bg-slate-900/60 border border-slate-600/40 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none text-slate-200 placeholder-slate-500"
                maxLength={500}
              />
              ...
              <div className="flex gap-3 mt-6">
                <button
                  ...
                  disabled={actionLoading}
                  className="flex-1 bg-slate-700/60 text-slate-300 py-2 px-4 rounded-xl hover:bg-slate-600/60 disabled:opacity-50 transition-colors border border-slate-600/40"
                >
                  Batal
                </button>
                <button
