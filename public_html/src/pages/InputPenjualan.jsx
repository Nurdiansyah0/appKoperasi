                    ...
                    <div className="border-t border-slate-600/40 pt-3 mt-3">
                      ...
                      <div className="mb-3">
                        ...
                        {memberData ? (
                          ...
                          <div className="text-sm text-slate-500 text-center py-3 border border-dashed border-slate-600/40 rounded-xl bg-slate-800/20">
                          ...
                          <div className="absolute z-10 w-full mt-1 bg-slate-800 border border-slate-600/40 rounded-xl shadow-lg backdrop-blur-lg">
                            {[
                              ...
                              <button
                                ...
                                className="w-full px-3 py-2 text-sm text-white text-left hover:bg-slate-700/60 transition-colors first:rounded-t-xl last:rounded-b-xl border-b border-slate-600/40 last:border-b-0 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                              >
                                <div
